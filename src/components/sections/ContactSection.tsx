...
export default function ContactSection() {
  ...
  return (
    <div
      ...
      id="contact"
    >
      <section className="flex flex-col gap-4 md:flex-row max-w-295 mx-auto p-4 border border-[#414141]">

        {/* Map */}
        <AnimateIn variant="slide-left" className="relative w-full md:w-[30%] min-h-90 md:min-h-106.75">
          <ContactMap />
        </AnimateIn>
        ...
        <AnimateIn variant="slide-right" delay={0.15} className="flex flex-col justify-start w-full md:w-[70%] overflow-hidden backdrop-blur-md">
          ...
          <div className="flex flex-col gap-3 px-8 pt-8 pb-6">
            ...
            <p
              ...
              style={{ fontSize: "clamp(22px, 2.8vw, 36px)", lineHeight: "1.2", whiteSpace: "pre-line" }}
            >
              {t("contact.address")}
            </p>
          </div>
          ...
          >
            {/* Call Us */}
            <a href="tel:+37367666600" className="flex flex-col items-center justify-around flex-1 py-7 px-4 no-underline transition-opacity hover:opacity-75">
              <strong className={`${ims} text-white`} style={{ fontSize: "clamp(18px, 2vw, 28px)", lineHeight: "30px" }}>
                {t("contact.callUs")}
              </strong>
              <PhoneIcon className="w-14 h-14 my-4 text-[#b0b0b0]" />
              <strong className={`${ims} text-white`} style={{ fontSize: "clamp(14px, 1.6vw, 24px)", lineHeight: "24px" }}>
                +373-67-666-600
              </strong>
            </a>
            ...
            {/* Email Us */}
            <a href="mailto:proroomdetailing@gmail.com" className="flex flex-col items-center justify-around flex-1 py-7 px-4 no-underline transition-opacity hover:opacity-75">
              <strong className={`${ims} text-white`} style={{ fontSize: "clamp(18px, 2vw, 28px)", lineHeight: "30px" }}>
                {t("contact.emailUs")}
              </strong>
              <MailIcon className="w-14 h-14 my-4 text-[#b0b0b0]" />
              <strong className={`${ims} text-white text-center break-all`} style={{ fontSize: "clamp(12px, 1.4vw, 24px)", lineHeight: "24px" }}>
